...
class Group:
    ...
    def __init__(self, group_unit_creator: Optional[GroupUnitCreator] = None, group_unit_pool: Optional[GroupUnitPool] = None, active_unit: Optional[GroupUnit] = None):
        ...
        if active_unit is None:
            active_unit = self.create_group_unit(nonce=Nonce(items=(Unit(value=0, type_ref="int"),)), owners=GroupSubUnit(items=(Unit(value="J", type_ref="str"),)), creds=GroupSubUnit(items=(Unit(value="pass", type_ref="str"),)), data=Data(items=(Unit(value="Hello, world!", type_ref="str"),)))
