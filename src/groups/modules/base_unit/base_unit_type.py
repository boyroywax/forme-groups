...
from .base_unit_type_scanners import TypeScanners



_DEFUALT_UNIT_TYPE: str = _DEFUALT_UNIT_TYPES['string']['unit_type']


class BaseUnitTypeException(Exception):
    """
    The BaseUnitTypeException class manages the exceptions for the BaseUnitType class.
    """

    def __init__(self, message: str):
        """
        Initializes the BaseUnitTypeException class.
        """
...
class BaseUnitType():
    ...
    def __init__(
        ...
        if _unit_type_prefix is not None:
            self.set_unit_type_prefix(_unit_type_prefix)

        if _unit_type_suffix is not None:
            self.set_unit_type_suffix(_unit_type_suffix)
